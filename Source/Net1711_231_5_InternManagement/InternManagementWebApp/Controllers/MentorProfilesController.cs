...
namespace InternManagementWebApp.Controllers
{
    public class MentorProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MentorId,MentorName,MentorAddress,MentorPhone,MentorEmail")] MentorProfile mentorProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MentorId,MentorName,MentorAddress,MentorPhone,MentorEmail")] MentorProfile mentorProfile)
        {
